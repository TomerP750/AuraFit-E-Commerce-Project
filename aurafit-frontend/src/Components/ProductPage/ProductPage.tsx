...
export function ProductPage(): JSX.Element {
    ...
    return (
        // <div className="ProductPage flex flex-col-reverse lg:flex-row justify-between items-start p-4 lg:p-8 ">
        //
        //     {/* Left: Images */}
        //     <div className="flex flex-col w-full lg:w-1/2 gap-4 overflow-y-auto">
        //         <div className="self-center w-[300px] h-[300px] sm:h-[600px] sm:w-full bg-yellow-200"></div>
        //         <div className="flex flex-col sm:flex-row gap-4">
        //             <div className="w-full sm:w-1/2 h-[200px] sm:h-[400px] bg-cyan-200"></div>
        //             <div className="w-full sm:w-1/2 h-[200px] sm:h-[400px] bg-cyan-200"></div>
        //         </div>
        //     </div>
        //
        //     {/* Right: Info */}
        //     <div className="flex flex-col w-full lg:w-[45%] space-y-4 overflow-y-auto">
        //         <p className="text-sm sm:text-base md:text-lg font-medium">Sale 50% off</p>
        //         <p className="text-xl sm:text-2xl md:text-3xl font-semibold">Product Name</p>
        ...
        //             <button className="bg-black text-white py-3 px-8 w-full sm:w-auto active:bg-gray-700 transition duration-300">
        //                 Add To Cart
        //             </button>
        //             <button className="bg-gray-200 rounded-3xl py-3 px-5 w-full sm:w-auto hover:bg-black hover:text-white active:bg-gray-700 transition duration-300 flex justify-center">
        ...
        //             type="button"
        //             className="flex items-center justify-between w-full sm:w-1/2 bg-gray-100 rounded-lg py-2 px-4 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 transition cursor-pointer"
        //         >
        //         <span className="text-gray-700 font-medium">Description</span>
        //             <FiChevronRight className="text-gray-700 text-xl"/>
        //         </button>
        //
        //         {descriptionOpened && <ProductPageSidebar isOpen={descriptionOpened} onClose={()=>setDescriptionOpened(false)}/>}
        //
        //     </div>
        //
        // </div>
